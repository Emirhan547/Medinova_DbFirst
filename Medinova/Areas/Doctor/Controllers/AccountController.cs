...
namespace Medinova.Areas.Doctor.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginDto model, string returnUrl)
        {
            ...
            if (userRole != "Doctor")
            {
                ModelState.AddModelError("", "Bu giriş sayfası sadece doktorlar içindir");
                return View(model);
            }
            ...
            LogActivity(user.UserId, "Doctor Login", "Account", "Doctor");
        ...
        public ActionResult Logout()
        {
            ...
            {
                LogActivity((int)Session["userId"], "Doctor Logout", "Account", "Doctor");
            }
